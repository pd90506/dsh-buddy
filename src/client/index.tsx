...
const en = {
	...
	skillsVisibilityProject: "A project folder",
	skillsVisibilityGlobal: "All sessions",
	skillsProjectPath: "Project folder",
	skillsProjectPathHint: "Absolute path. Only sessions whose working directory is inside it will see this skill.",
	skillsProjectApply: "Apply",
	...
	skillsSpendTitle: "Review spend",
	skillsSpendEmpty: "No reviews recorded yet.",
	skillsSpendSteps: "Model rounds",
	skillsSpendIn: "Input tokens",
	skillsSpendOut: "Output tokens",
	skillsSpendCacheRead: "Cache reads",
	skillsRollback: "Undo",
...
const zh: typeof en = {
	...
	skillsVisibilityProject: "某个项目目录",
	skillsVisibilityGlobal: "所有会话",
	skillsProjectPath: "项目目录",
	skillsProjectPathHint: "绝对路径。只有在它下层目录里运行的会话能看到这个技能。",
	skillsProjectApply: "应用",
	skillsManagedByAgent: "自动",
	skillsManagedByHuman: "你的",
	skillsUses: "使用次数",
	skillsLedgerTitle: "改动记录",
	skillsLedgerEmpty: "还没有改动记录。",
	skillsSpendTitle: "总结花费",
	skillsSpendEmpty: "还没有总结记录。",
	skillsSpendSteps: "模型轮次",
	skillsSpendIn: "输入 token",
	skillsSpendOut: "输出 token",
	skillsSpendCacheRead: "缓存读取",
	skillsRollback: "撤销",
